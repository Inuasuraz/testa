...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepeatText.setText("ทุกๆ " + mRepeatNo + "ชั่วโมง");
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (input.getText().toString().length() == 0) {
                            mRepeatNo = Integer.toString(1);
                            mRepeatNoText.setText(mRepeatNo);
                            mRepeatText.setText("ทุกๆ " + mRepeatNo + "ชั ่วโมง");
                        }
                        else {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("ชื่อรายการไม่สามารถว่างได้");
                }
...
*/
        ...
        if (mActive.equals("true")) {
            ...
            Toast.makeText(this, "เวลาปลุกเป็น " + selectedTimestamp,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("Every " + repeatNo + " " + "Hour" + "(s)");
            // Setup up active buttons
            // Setup repeat switch
